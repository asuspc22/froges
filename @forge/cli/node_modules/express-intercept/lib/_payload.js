...
class ResponsePayload {
    ...
    getBuffer() {
        ...
        // decompress Buffer
        const encoding = (0, _compression_1.findEncoding)(res.getHeader("Content-Encoding"));
        if (encoding && buffer.length) {
            buffer = (0, _compression_1.decompressBuffer)(buffer, encoding);
        }
        return buffer;
    }
    setBuffer(buffer) {
        ...
        const encoding = (0, _compression_1.findEncoding)(res.getHeader("Content-Encoding"));
        if (encoding && buffer.length) {
            buffer = (0, _compression_1.compressBuffer)(buffer, encoding);
        }
